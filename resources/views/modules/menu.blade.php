...
<div id="head">
  <!--
        <div class="logo">
           logo
           <img src="public/images/logo1.png" alt="#" border="0"/>
        </div>
      -->
        <div class="banner">
 ...
 <!-- main menu  navbar -->
    ...
    <nav class="navbar navbar-default navbar-top" role="navigation" id="main-Nav" style="background-color: #16a085;margin-bottom: 5px;font-size: 18px;">
      <div class="container">  
        <div class="row">
